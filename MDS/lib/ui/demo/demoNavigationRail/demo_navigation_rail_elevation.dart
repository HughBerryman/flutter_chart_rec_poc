...
class DemoNavigationRailElevation extends StatelessWidget {
  const DemoNavigationRailElevation({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        const ComponentSubheader(title: 'With Elevation'),
        Row(
          children: [
            Padding(
