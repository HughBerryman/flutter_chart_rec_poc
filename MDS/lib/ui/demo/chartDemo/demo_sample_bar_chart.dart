    ...
    return Column(
      ...
      children: [
        const Padding(
          ...
          child: ComponentHeader(title: 'Syncfusion - Misc. Charts'),
        ),
        const Padding(
          padding: EdgeInsets.only(bottom: FMIThemeBase.basePadding4),
          child: ComponentHeader(title: 'Default Bar Chart'),
        ),
        const Padding(
          padding: EdgeInsets.only(bottom: FMIThemeBase.basePadding4),
          child: Text('Sample implementation using MDS Tokens'),
        ),
        SfCartesianChart(
          plotAreaBorderWidth: FMIThemeBase.baseBorderWidthNone,
          title: ChartTitle(
              text: 'Default Bar Chart',
              textStyle: Theme.of(context).textTheme.chartTitle.copyWith(
          ...
          primaryXAxis: CategoryAxis(
              ...
              labelStyle: Theme.of(context).textTheme.legendLabel.copyWith(
                  color: Theme.of(context).colorScheme.textChartText)),
