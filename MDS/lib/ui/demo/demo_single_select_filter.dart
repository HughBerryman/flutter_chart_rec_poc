...
class DemoSingleSelectFilter extends StatefulWidget {
  const DemoSingleSelectFilter({super.key});

  @override
  State<DemoSingleSelectFilter> createState() => _DemoSingleSelectFilterState();
}
...
class _DemoSingleSelectFilterState extends State<DemoSingleSelectFilter> {
  ...
  List<FilterMultiSelectEmployee> filtersEmployees = [
    FilterMultiSelectEmployee(
        ...
        employee:
            Employee(employeeID: '1', displayName: 'Charles Dickens')),
    FilterMultiSelectEmployee(
        value: false,
        text: 'Emily Bronte',
        employee: Employee(employeeID: '2', displayName: 'Emily Bronte')),
    FilterMultiSelectEmployee(
        value: false,
        text: 'Bob Jancoski',
        employee: Employee(
...
class FilterSingleSelect {
  ...
  FilterSingleSelect(
      {this.id, required this.value, required this.text, this.leading});
}
