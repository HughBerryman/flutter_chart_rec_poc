...
class DemoExpandableKpiCard extends StatefulWidget {
  const DemoExpandableKpiCard({super.key});

  @override
  State<DemoExpandableKpiCard> createState() => _DemoExpandableKpiCardState();
}

class _DemoExpandableKpiCardState extends State<DemoExpandableKpiCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        const ComponentHeader(title: 'Fmi Expandable Kpi Card'),
        Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                Container(
                  width: FMIThemeBase.baseContainerDimension300,
                        ...
                        return Column(
                          children: [
                            ...
                            ListView.builder(
                              itemBuilder: ((context, index) {
                                return Visibility(
                                    visible: kpiArr[rowIndex][index].isShown ??
                                        false,
                                    child: Column(
                                      children: [
                                        Padding(
