...
class DemoFabHero extends StatelessWidget {
  const DemoFabHero({Key? key}) : super(key: key);
  @override
          ...
          child: Column(
            ...
            children: [
              const ComponentHeader(
                  title: 'FAB – Hero – FmiFloatingActionButtonTheme.hero'),
              ScrollConfiguration(
                behavior:
                  ...
                  child: Row(
                    children: [
                      Padding(
                        ...
                        child: Theme(
                          data: FmiFloatingActionButtonTheme.hero(context),
