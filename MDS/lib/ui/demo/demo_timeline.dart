...
class _DemoTimelineState extends State<DemoTimeline> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        const ComponentHeader(title: 'Fmi Timeline'),
        const Padding(
          padding: EdgeInsets.only(
            top: FMIThemeBase.baseGapLarge,
          ),
          child: ComponentSubheader(title: 'In Progress Timeline Step'),
        ),
        Padding(
        ...
        const Padding(
          ...
          child: ComponentSubheader(title: 'Success Timeline Step'),
        ),
        Padding(
          padding: const EdgeInsets.only(top: FMIThemeBase.basePaddingLarge),
          child: FmiTimeline(
        ...
        const Padding(
          ...
          child: ComponentSubheader(title: 'Error Timeline Step'),
        ),
        Padding(
          padding: const EdgeInsets.only(top: FMIThemeBase.basePaddingLarge),
          child: FmiTimeline(
        ...
        const Padding(
          ...
          child: ComponentSubheader(title: 'Timeline Step with Sub-Steps'),
        ),
        Padding(
          padding: const EdgeInsets.only(top: FMIThemeBase.basePaddingLarge),
          child: FmiTimeline(
        ...
        const Padding(
          ...
          child: ComponentSubheader(title: 'Timeline with Customization'),
        ),
        Padding(
          padding: const EdgeInsets.only(top: FMIThemeBase.basePaddingLarge),
          child: FmiTimeline(
