...
Example with Expansion Tiles and Label Headers
  ...
  List<FmiDrawerItem> getChildren1(BuildContext context) {
    return List.generate(
        ...
        (index) => FmiDrawerItem(
            ...
            trailing: showTrailingIcons ? FaIcon(
              FontAwesomeIcons.arrowRight,
              size: FMIThemeBase.baseIconXSmall,
  ...
  List<FmiDrawerItem> items(BuildContext context) {
    List<FmiDrawerItem> list = [
      ...
      FmiDrawerItem(
          ...
          label: 'Label 0',
          trailing: showTrailingIcons ? const FaIcon(FontAwesomeIcons.arrowRight,
              size: FMIThemeBase.baseIconXSmall) : null),
      FmiDrawerItem(
        enabled: false,
