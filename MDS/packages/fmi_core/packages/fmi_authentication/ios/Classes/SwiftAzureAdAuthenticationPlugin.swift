...
public class SwiftAzureAdAuthenticationPlugin: NSObject, FlutterPlugin {
    ...
    fileprivate func getResultLogin(_ authResult: MSALResult) -> String?{
        ...
        let jsonObject:[String : Any] = ["accessToken":authResult.accessToken, "expiresOn": "\(String(describing: authResult.expiresOn))", "idToken":authResult.idToken];
